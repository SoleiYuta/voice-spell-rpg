...
現在フェーズ: **Web版へピボット (Next.js・適応型AIゲームマスター)** | フェーズ0〜5 実装済み ✅ | 提出〆切 2026-07-10
...
- [[AI-Grimoire/09_役割分担_WBS_ガント]] — **5人の担当・WBS・ガント (〜7/10)**
- [[AI-Grimoire/10_Web設計書]] — **🆕 Web版(Next.js)設計・着手用（フォルダ/画面/API/担当）**
